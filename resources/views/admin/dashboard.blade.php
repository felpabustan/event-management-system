                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">{{ $totalEvents }}</dd>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">{{ $upcomingEvents }}</dd>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6 text-gray-900">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">{{ $totalRegistrations }}</dd>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('events.index') }}" class="text-blue-600 hover:text-blue-500 text-sm font-medium">
                            View all events →
                        </a>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            {{-- <a href="{{ route('homepage-settings.index') }}" class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-purple-700 focus:bg-purple-700 active:bg-purple-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
